    ...
    <Link to="/" className="navbar-brand"><img style={{width:"15rem",height:"8rem",zIndex:"1"}} src='assets/images/logo.png'></img></Link>
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent" style={{}}>
        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <Link className="nav-link text-danger active me-5  navLink" to="/" style={{borderBottom:"1px solid red"}}>Home</Link>
          </li>
          <li className="nav-item">
          <Link className="nav-link me-5 text-primary navLink" to="/contact">Contact Us</Link>
          </li>
          <li className="nav-item">
          <Link className="nav-link me-5 text-primary navLink" to="/whyStudy">About Us</Link>
          </li>
          <li className="nav-item">
          <Link className="nav-link me-5 text-primary navLink" to="/faculty">Faculty</Link>
          </li>
          <li className="nav-item">
          <Link className="nav-link me-5 text-primary navLink" to="/courses">Courses</Link>
          </li>
